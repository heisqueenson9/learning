...
class Settings(BaseSettings):
    ...
    # Database URL — falls back to SQLite for local; supports Postgres on Render/Railway/Vercel
    SQLALCHEMY_DATABASE_URI: str = os.getenv("DATABASE_URL", "sqlite:///./apex.db")
